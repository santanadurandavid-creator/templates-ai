  ...
  return (
    <TooltipProvider delayDuration={4000}>
      <Tooltip>
        ...
        <TooltipContent className="max-w-xs p-4 bg-popover/95 backdrop-blur border-accent/20">
          <p className="font-bold text-sm mb-2 text-primary">{template.title}</p>
          <p className="text-xs leading-relaxed text-foreground/90">{template.content}</p>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
  );
