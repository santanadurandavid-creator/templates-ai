...
export function TemplateList({ templates, isLoading, onCopy, onEdit, onDelete, onRephrase, onShowHistory, onAddNew }: TemplateListProps) {
        ...
        return (
            <div className="space-y-4">
                <div className="flex justify-between items-center gap-4">
                    <h2 className="text-xl font-semibold tracking-tight truncate">Todas las Plantillas</h2>
  ...
  return (
    <div className="space-y-4">
        <div className="flex justify-between items-center gap-4">
            <h2 className="text-xl font-semibold tracking-tight truncate">Todas las Plantillas</h2>
            <Button variant="outline" size="icon" onClick={onAddNew} className="shrink-0" title="Añadir Nueva Plantilla">
